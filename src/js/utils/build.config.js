...
/** DEASCI_CONFIG_NAME may be provided by a build script. If it is not provided,
 * then we defaut to "Release".
 */
if (!window.DEASCI_CONFIG_NAME) {
  /** @const */ window.DEASCI_CONFIG_NAME = "Release";
}

/** Configuration options. These are assumed to be read-only and should not
 * change. Hopefully closure-compiler will understand this and optimize the
 * code.
 */
var BuildConfigs = {
  "Release": {
  ...
  "Debug": {
    ...
    TEXTHILITE_TRANSPARENT_TEXT:
        true,  // Textarea's text color will be semi transparent
    LOG: true
  }
};
