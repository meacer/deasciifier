...
b){if(a&&!this.A(a))return b=new this.J(a,b),this.ub(a),b.init(),this.Ra(a,b),b},Gb:function(a){if(this.A(a)){for(var b=0;b<r.length;b++){var d=r[b];c.Fb(a,d.name,d.R)}this.Ra(a,null)}else console.log("Deasciifier already not installed for this text area")},eb:function(a){if(a=this.A(a))return a.Oa(B);console.log("DeasciifyBox not installed for this text area");return null},ab:function(a){if(a=this.A(a))return a.Oa(H);console.log("DeasciifyBox not installed for this text area");return null},la:function(a){var b=
this.ea,c;for(c in b){var d=b[c];d&&d.la(a)}},zb:function(a){a=a.ea;for(var b in a){var c=a[b];c&&c.la(null)}},Ab:function(a,b,c){(a=this.A(a))&&a.options.set(b,c)},J:function(a,b){this.a=a;this.options=new h(b,A);this.b=this.h=null}};l.J.prototype={init:function(){var a=document.body||document.getElementsByTagName("body")[0],b=new h({resizeable:this.options.get("resizeable",!0)});this.h=e.da(this.a,b);if(this.options.get("enable_corrections",!0)){var c=this;this.b={position:{start:0,end:0},ka:g.create(a,
function(a){return c.X(a)},function(a){return c.L(a)})}}},L:function(a){var b=U(n,"confirmApplyCorrectionToAll");if(this.b&&confirm(b)){this.F();b=a.changedPositions||[];for(var c=0;c<b.length;c++)b[c]+=this.b.position.start;a=this.T(a.H,a.text);b=b.concat(a);0<b.length&&this.l(b,!0)}return!0},T:function(a,b){var c=this.a.value;a=c.replace(new RegExp(a,"g"),b);this.D(a);return f.ib(c,a)},X:function(a){return this.b?(a.reset&&this.F(),this.V(a),!0):!1},D:function(a){var b=d.P(this.a);this.a.value=
a;d.ha(this.a,b)},V:function(a){this.D(f.Cb(this.a.value,this.b.position.start,this.b.position.end,a.text));var b=[];if(a.changedPositions)for(var c=0;c<a.changedPositions.length;c++)b.push(a.changedPositions[c]+this.b.position.start);this.l(b,!0)},l:function(a,b){if(this.h&&this.options.get("highlight",!0)&&(a&&0<a.length||b)){this.h.clear();for(b=0;b<a.length;b++){var c=a[b];this.h.tb(c,c+1)}this.h.update()}},B:function(a){a&&a.text&&(this.a.value=a.text,this.l(a.changedPositions))},F:function(){this.b&&
this.b.ka&&this.b.ka.hide()},Eb:function(){if(this.h&&this.b&&this.options.get("show_corrections",!0)){this.F();var a=d.P(this.a);if(a.start==a.end)if(a=a.start,0==f.vb(this.a.value,a))this.F();else{a=f.Ja(this.a.value,a);var b=this.a.value.substring(a.start,a.end);if(0!=g.sb(b)){var c=this.h.jb(a.start,a.end),e=c.left,h=c.top+c.height+3;c=c.width;this.b.position.start=a.start;this.b.position.end=a.end;this.b.ka.show(e,h,c,b)}}}},W:function(){var a=d.P(this.a),b=null;a.start==a.end?b=f.rb(this.a.value,
a.start):b={start:a.start,end:a.end};b=B.wa(this.a.value,b.start,b.end);this.B(b);d.ha(this.a,a)},Oa:function(a){this.b.ka&&this.F();var b=d.P(this.a);if(b.start==b.end){var c=U(n,"confirmFullTextDeasciify");if(this.options.get("fullTextConfirmation",!0)&&!confirm(c))return null;a=a.Na(this.a.value)}else a=a.wa(this.a.value,b.start,b.end-1);this.B(a);d.ha(this.a,b);return a},yb:function(a){if(!this.options.get("auto_convert",!0))return!1;f.xb(a)&&this.W()},aa:function(){if(this.h){var a=d.P(this.a);
this.h.Ga(a.start);this.h.Ga(a.end)}},Da:function(){this.a.scrollHeight>this.a.clientHeight&&(this.a.style.height=this.a.scrollHeight+3+36+"px");this.h&&this.h.za()},la:function(){this.h&&this.h.za()},update:function(){this.aa();this.Da()}};(function(){c.M(window,"resize",function(a){l.la(a)});setInterval(function(){l.zb(l)},500)})();R.Ta=l;l.install=l.da;l.uninstall=l.Gb;l.deasciifySelection=l.eb;l.asciifySelection=l.ab;l.setOption=l.Ab;l.setUILang=l.Db;window.DeasciifyBox=R.Ta})(window.Deasciifier,
window.Asciifier,R.ma,R.Ca,R.$a,R.Ba,R.Y,S);(function(a,b,c){function d(){t.shift=!t.shift;t.caps=!t.caps;f()}function e(a){$(k.Z()).focus();b.Bb(k.Z(),a)}function f(){t.caps?(w.style.display="block",x.style.display="none"):(w.style.display="none",x.style.display="block")}function g(a){return function(){t.shift&&d();e(a)}}function h(b,d,e){var f=document.createElement("input");f.type="button";f.value=b;e&&a.addClass(f,e);d&&c.M(f,"click",d);return f}function q(b){var c=1<b.length&&"_"==b.charAt(0);b=c?b.substring(1):b;b=h(b,g(b));c&&a.w(b,
